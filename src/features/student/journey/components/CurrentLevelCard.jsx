    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 px-1.5 py-0.5 rounded-sm bg-[rgba(16,185,129,0.1)] text-[16.325px] font-semibold leading-normal text-[#10b981]">
            Active Stage
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="text-[14px] font-normal leading-normal text-[#53657D]">
